...
OUTPUT_DIR="debugs/framepack_lora"
DATA_ROOT="/home/t-zelonglv/blob/zelong/data/TartanAir_544x704"
...
DATA_ARGS=(
    --data_root ${DATA_ROOT}
    --train_resolution "16x544x704"  # (frames x height x width), frames should be 8N+1
)
